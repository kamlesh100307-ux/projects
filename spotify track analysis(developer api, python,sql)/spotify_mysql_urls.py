...
sp = spotipy.Spotify(auth_manager=SpotifyClientCredentials(
    client_id='d0a7ef4fbb1d4e49a26c11b38107fecf',  # Replace with your Client ID
    client_secret='3fbd32d3d02d4f788d31d0bd4fc76240'  # Replace with your Client Secret
))
...
db_config = {
    ...
    'password': 'Kamleshu@102030',   # Replace with your MySQL password
